"""Data coordinator for receiving HLK2410D-B updates."""
...
class HLK2410DBCoordinator(DataUpdateCoordinator[None]):
    """Data coordinator for receiving HLK2410D-B updates."""

    config_entry: HLK2410DBConfigEntry
    ...
    def __init__(
        ...
        self._debounced_update_job = HassJob(
            ...
            f"HLK2410D-B {ld2410_ble.address} BLE debounced update",
        )
